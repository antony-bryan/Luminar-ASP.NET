<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="page5.aspx.cs" Inherits="ASPWebApp_Dec.page5" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextBox2" ErrorMessage="Age between 20 and 50" MaximumValue="50" MinimumValue="20" Type="Integer"></asp:RangeValidator>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
